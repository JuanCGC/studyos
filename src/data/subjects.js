export const CHAP_MAP = {
  "HTTP & REST Fundamentals": "api-basics",
  "Status Codes & Headers": "api-basics",
  "RestAssured setup + pom.xml": "project1",
  "PostsTest.java — happy path": "project1",
  "JSON Schema validation": "api-testing",
  "Negative tests & boundaries": "api-testing",
  "Auth testing — JWT & OAuth": "auth",
  "Security checklist — IDOR, XSS": "auth",
  "Data-driven tests @ParameterizedTest": "project1",
  "Allure reporting": "project1",
  "UsersTest.java Complete": "project1",
  "CommentsTest.java Complete": "project1",
  "Pact contract tests": "project2",
  "WireMock stubs": "project2",
  "CI/CD — GitHub Actions gate": "cicd",
  "k6 performance gates": "cicd",
  "Pipelines & Stages": "cicd",
  "GitHub Actions basics": "cicd",
  "Quality gates": "cicd",
  "Docker fundamentals": "project2",
  "Docker Compose for Tests": "project2",
  "Matrix builds": "project2",
  "Environments & Secrets": "cicd",
  "Allure + Artifacts": "project2",
  "Setup & Configuration": "playwright",
  "API Tests with Request Fixture": "playwright",
  "Basic E2E Tests": "playwright",
  "Page Object Model": "playwright",
  "Hybrid API + UI tests": "playwright",
  "Visual regression testing": "project-playwright",
  "Network interception": "project-playwright",
  "Cross-browser testing": "project-playwright",
  "Debugging & Traces": "playwright",
  "GitHub Actions integration": "cicd",
  "demoqa.com Full Project": "project-playwright",
  "Dev Org setup + SF CLI": "sf-overview",
  "Apex basics": "apex-testing",
  "@isTest & @TestSetup": "apex-testing",
  "HttpCalloutMock": "apex-testing",
  "System.runAs() & FLS": "apex-testing",
  "Governor limits testing": "apex-testing",
  "Debug logs reading": "apex-testing",
  "LWC Jest tests": "apex-testing",
  "Batch Apex testing": "apex-testing",
  "Platform Events testing": "sf-project",
  "Flow Testing in Apex": "sf-project",
  "SF CLI CI/CD pipeline": "sf-project",
  "Multi-org regression": "sf-project",
  "Copado basics": "sf-project",
  "Collections & Workspaces": "project-postman",
  "Environment Variables": "project-postman",
  "pm.test assertions": "project-postman",
  "Pre-request scripts": "project-postman",
  "Schema validation": "api-testing",
  "Chaining with Env Variables": "project-postman",
  "Collection Runner": "project-postman",
  "Data-Driven with CSV": "project-postman",
  "Newman CLI": "project-postman",
  "HTML reports": "project-postman",
  "GitHub Actions + Newman": "project-postman",
  "Monitors": "project-postman",
  "Mock servers": "project-postman",
  "API documentation": "frameworks",
  "Flows (new)": "project-postman",
  "Contract testing": "project2",
  "Performance testing": "cicd",
  "Negative test folder": "project-postman",
  "Advanced scripting": "project-postman",
  "Final Exam": "cheatsheet",
  "API design patterns": "api-testing",
  "GraphQL testing": "frameworks",
  "gRPC testing": "frameworks",
  "Data-Driven Testing with External JSON": "playwright",
  "Multi-Tenant Config Engine": "playwright",
  "Harness Pipelines Fundamentals": "cicd",
  "Quality Gates in Harness": "cicd",
  "Harness CD Pipeline": "cicd",
  "K6 Setup & VU Concepts": "cicd",
  "Smoke Testing": "cicd",
  "Load Testing": "cicd",
  "Stress Testing": "cicd",
  "Soak Testing": "cicd",
  "Thresholds & Metrics": "cicd",
  "K6 in CI/CD": "cicd",
  "Final Project: Black Friday": "cicd",
  "SQL Fundamentals & SELECT": "api-basics",
  "JOINs & Relationships": "api-basics",
  "GROUP BY & HAVING": "api-basics",
  "Subqueries & CTEs": "api-basics",
  "Data Integrity Validation": "api-basics",
  "Duplicate & Orphan Detection": "api-basics",
  "Post-Automation Audit": "api-basics",
  "Final Project: DB Audit": "api-basics"
};

export const EMBEDDED_GUIDES = {
  // ── API TESTING ──────────────────────────────────────────
  'api_0':{
